...
PART2_SECTION_STRUCTURE = {
    "2.1": {
        ...
        "evidence_refs": ["evidence.listing_snapshots", "evidence.sold_transactions"],
    ...
    "2.4": {
        ...
        "evidence_refs": ["evidence.product_catalog", "evidence.sold_transactions"],
    ...
    "2.5": {
        ...
        "evidence_refs": ["evidence.reviews"],
        "rule_refs": ["gate.voc_risk"],
    },
    "2.6": {
        "title": "货架动态与生存分析",
        ...
        "channel_scope": ["Amazon", "eBay", "TikTok Shop", "Walmart"],
        "master_data_refs": ["mdm.sku", "mdm.channel"],
        "evidence_refs": ["evidence.listing_snapshots"],
        "rule_refs": ["gate.shelf_stability"],
    },
}
